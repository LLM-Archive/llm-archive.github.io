...
def build_site_row(
    ...
    row = {
        ...
        "analysis_code_sha": measurement.get("analysis_code_sha", ""),
        "returned_model_id": measurement.get("returned_model_id", ""),
...
def build_site_html(
    ...
    replacements = {
        ...
        "@@OPEN_LANE_DIR_HREF@@": _rel_prefix(data_dir, out_dir) + "open-lane/",
